...
const int SOUNDS_TOTAL = 12;
int CUR_SOUND = 2;//lets start on the "I SEEE YOUUUUU.... there is no life in the void... only death"
...
int animationModesTotal = 5;
int animationModeIndex = 3;//default fade in and out
